...
export const en = {
	...
	'io.importDialog': 'Import birthdays and holidays',
	'io.exportDialog': 'Export birthdays and holidays',
	...
	'io.nothingFound': 'No birthdays or holidays were found in that file.',
